...
/**
 * ProductMediaGalleryEntryMetadata Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProductMediaGalleryEntryMetadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'productMediaGalleryEntryMetadata';
    ...
    protected static $openAPITypes = [
        'roles' => 'string[]',
        'alt' => '\OpenAPI\Client\Model\ProductLocalizedText'
    ];
    ...
    */
     ...
     * Sets alt
     *
     * @param \OpenAPI\Client\Model\ProductLocalizedText|null $alt alt
     *
     * @return self
     */
