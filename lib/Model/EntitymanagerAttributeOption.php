...
/**
 * EntitymanagerAttributeOption Class Doc Comment
 *
 * @category Class
 * @package  GeminiCommerce\Product
 * @author   OpenAPI Generator team
 ...
 */
class EntitymanagerAttributeOption implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'entitymanagerAttributeOption';
    ...
    protected static $openAPITypes = [
        ...
        'id' => 'string',
        'code' => 'string',
        'value' => '\GeminiCommerce\Product\Model\ProductentitymanagerLocalizedText',
        'swatches' => '\GeminiCommerce\Product\Model\EntitymanagerAttributeOptionSwatch[]'
    ];
    ...
    */
     ...
     * Sets option
     *
     * @param array<string,string>|null $option option
     *
     * @return self
     */
     ...
     * Gets value
     *
     * @return \GeminiCommerce\Product\Model\ProductentitymanagerLocalizedText|null
     */
     ...
     * Sets value
     *
     * @param \GeminiCommerce\Product\Model\ProductentitymanagerLocalizedText|null $value value
     *
     * @return self
     */
     ...
     * Gets swatches
     *
     * @return \GeminiCommerce\Product\Model\EntitymanagerAttributeOptionSwatch[]|null
     */
     ...
     * Sets swatches
     *
     * @param \GeminiCommerce\Product\Model\EntitymanagerAttributeOptionSwatch[]|null $swatches swatches
     *
     * @return self
     */
    ...
    {
        if (is_null($swatches)) {
            throw new \InvalidArgumentException('non-nullable swatches cannot be null');
        }
