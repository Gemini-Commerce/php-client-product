...
/**
 * EntitymanagerAttributeWriteError Class Doc Comment
 *
 * @category Class
 * @package  GeminiCommerce\Product
 * @author   OpenAPI Generator team
 ...
 */
class EntitymanagerAttributeWriteError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'entitymanagerAttributeWriteError';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('attribute_code', $data ?? [], null);
    ...
    */
     ...
     * Sets attribute_code
     *
     * @param string|null $attribute_code attribute_code
     *
     * @return self
     */
    public function setAttributeCode($attribute_code)
    {
        if (is_null($attribute_code)) {
            throw new \InvalidArgumentException('non-nullable attribute_code cannot be null');
        }
